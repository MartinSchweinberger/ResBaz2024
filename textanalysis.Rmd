---
title: "Text Analytics part 2: Interactive Text Analysis with LADAL Tools"
...
# create kwic
kwic_alice <- quanteda::kwic(x = tokens(text_chapters), # define text(s) 
                             # define pattern
                             pattern = "alice",
                             # define window size
                             window = 5) %>%
...
m_eng <- udpipe_load_model(here::here("english-ewt-ud-2.5-191206.udpipe"))
```
